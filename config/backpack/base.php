...
return [
    ...
    */
    ...
    'project_name' => 'ДЕПАРТАМЕНТ КІБЕРПОЛІЦІЇ НАЦІОНАЛЬНОЇ ПОЛІЦІЇ УКРАЇНИ',

    // Menu logos
    'logo_lg'   => '<b>ДЕПАРТАМЕНТ КІБЕРПОЛІЦІЇ НАЦІОНАЛЬНОЇ ПОЛІЦІЇ УКРАЇНИ</b>',
    'logo_mini' => '<b>ДКНПУ</b>',

    // Developer or company name. Shown in footer.
    'developer_name' => 'Yason and Vanya',
